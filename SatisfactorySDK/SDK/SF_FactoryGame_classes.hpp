...
public:
	...
	class UStaticMesh*                                 mJointMesh;                                               // 0x0618(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UStaticMesh*                                 mShelfMesh;                                               // 0x0620(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	class USceneComponent*                             mMeshDisplayRoot;                                         // 0x0578(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	...
	class UBoxComponent*                               mClearanceBox;                                            // 0x0588(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UFGColoredInstanceMeshProxy*                 mMeshComponentProxy;                                      // 0x0590(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        mIconMesh;                                                // 0x0598(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UTextRenderComponent*                        mTextRenderComponentFront;                                // 0x05A0(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UTextRenderComponent*                        mTextRenderComponentBack;                                 // 0x05A8(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent*                    mHologramParticleComponent;                               // 0x05B0(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UMaterial*                                   mIconMaterial;                                            // 0x05B8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterial*                                   mTextMaterial;                                            // 0x05C0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMinRotationRate;                                         // 0x05C8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMaxRotationRate;                                         // 0x05CC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMinIconScale;                                            // 0x05D0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMaxIconScale;                                            // 0x05D4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMinTextScale;                                            // 0x05D8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mMaxTextScale;                                            // 0x05DC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FRotator                                    mSignRotator;                                             // 0x05E0(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x05EC(0x0004) MISSED OFFSET
	struct FStandaloneSignData                         mSignData;                                                // 0x05F0(0x0028) (Net, SaveGame)
	...
	float GetMinRotationRate();
	float GetMinIconScale();
	float GetMeshScaleFromNormalizedValue(float Value);
	float GetMaxTextScale();
	float GetMaxRotationRate();
	float GetMaxIconScale();
	float GetCurrentNormalizedTextScale();
	float GetCurrentNormalizedIconScale();
};
...
public:
	...
	int                                                mMagSize;                                                 // 0x03D0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                mCurrentAmmo;                                             // 0x03D4(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, SaveGame, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData05[0x4];                                       // 0x0A68(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x8];                                       // 0x0A78(0x0008) MISSED OFFSET
	float                                              mMaxDPSFromRadiation;                                     // 0x0A80(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x0A84(0x001C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x13];                                      // 0x025D(0x0013) MISSED OFFSET
...
public:
	...
	class UFGSaveSystem*                               mSaveSystem;                                              // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    mOnNewError;                                              // 0x00B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UAnalyticsService*                           mAnalyticsService;                                        // 0x00C8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UFGErrorMessage*>                     mErrorList;                                               // 0x00D0(0x0010) (ZeroConstructor)
	struct FOnJoinSessionData                          mJoinSessionData;                                         // 0x00E0(0x00C8)
	unsigned char                                      UnknownData01[0x10];                                      // 0x01A8(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    mOnNatTypeUpdated;                                        // 0x01B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	class USplineComponent*                            mCachedSpline;                                            // 0x0328(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USkeletalMeshComponent*                      mCachedMesh;                                              // 0x0330(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0338(0x0004) MISSED OFFSET
	float                                              mCurrentTime;                                             // 0x033C(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	float                                              mOffsetMagnitude;                                         // 0x0340(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              mSecondsPerLoop;                                          // 0x0344(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x60];                                      // 0x0340(0x0060) MISSED OFFSET
...
public:
	...
	class AFGMinimapCaptureActor*                      mMinimapCaptureActor;                                     // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<struct FSignMeshIcon>                       mSignMeshIcons;                                           // 0x0028(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<struct FSignMeshIcon> GetSignMeshIcons();
};
